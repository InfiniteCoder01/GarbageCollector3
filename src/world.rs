...
impl Entity {
    pub fn pivot(&self) -> FVec2 {
        match self {
            Self::Platform(_) => <FVec2 as VectorImpl>::new(0 as _, 0 as _),
    ...
    pub fn render_mode(&self) -> RenderMode {
        match self {
            Self::Platform(_) => RenderMode::Tile { tileset: 3, tile: <UVec2 as VectorImpl>::new(4 as _, 3 as _), size: <UVec2 as VectorImpl>::new(1 as _, 1 as _) },
...
impl World {
    pub fn load() -> Self {
        Self {
            ...
            level_2: Level {
                bg_color: <Color as ColorImpl>::from_hex(0x0099DBFF),
                pixel_size: <UVec2 as VectorImpl>::new(848 as _, 304 as _),
                world_depth: 0,
                world_x: 1728,
                world_y: 0,
                foreground: Foreground {
                    size: <UVec2 as VectorImpl>::new(53 as _, 19 as _),
                    tiles: vec! {
                        None,
                        None,
                        None,
                ...
                entities: Entities {
                    ...
                    entities: vec! {
                        EntityObject::new(Entity::PlayerStartPosition(PlayerStartPosition {
                        }), <FVec2 as VectorImpl>::new(384 as _, 144 as _), <UVec2 as VectorImpl>::new(16 as _, 16 as _)),
                        EntityObject::new(Entity::Platform(Platform {
                            condition: "platform1 == True".to_owned(),
                            point_true: <UVec2 as VectorImpl>::new(28 as _, 11 as _),
                            point_false: <UVec2 as VectorImpl>::new(28 as _, 7 as _),
                        }), <FVec2 as VectorImpl>::new(448 as _, 160 as _), <UVec2 as VectorImpl>::new(16 as _, 8 as _)),
                        EntityObject::new(Entity::Platform(Platform {
                            condition: "platform1 == False".to_owned(),
                            point_true: <UVec2 as VectorImpl>::new(36 as _, 11 as _),
                            point_false: <UVec2 as VectorImpl>::new(36 as _, 15 as _),
                        }), <FVec2 as VectorImpl>::new(576 as _, 208 as _), <UVec2 as VectorImpl>::new(16 as _, 8 as _)),
                    }
                },
                ambient_decorations: AmbientDecorations {
                    size: <UVec2 as VectorImpl>::new(53 as _, 19 as _),
