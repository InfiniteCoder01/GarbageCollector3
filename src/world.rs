    ...
    pub fn load() -> Self {
        Self {
            level_0: Level {
                ...
                pixel_size: <UVec2 as VectorImpl>::new(768 as _, 304 as _),
                world_depth: 0,
                world_x: 0,
                world_y: 0,
                marks: Marks {
                    size: <UVec2 as VectorImpl>::new(48 as _, 19 as _),
                    entities: vec! {
                        EntityObject::new(Entity::PlayerStartPosition(PlayerStartPosition {
                        }), <FVec2 as VectorImpl>::new(16 as _, 224 as _), <UVec2 as VectorImpl>::new(16 as _, 16 as _)),
                        EntityObject::new(Entity::EndOfTheLevel(EndOfTheLevel {
                        }), <FVec2 as VectorImpl>::new(736 as _, 224 as _), <UVec2 as VectorImpl>::new(16 as _, 16 as _)),
                    }
                },
                solid: Solid {
                    size: <UVec2 as VectorImpl>::new(48 as _, 19 as _),
            ...
            level_1: Level {
                bg_color: <Color as ColorImpl>::from_hex(0x00BEFFFF),
                pixel_size: <UVec2 as VectorImpl>::new(496 as _, 304 as _),
                world_depth: 0,
                world_x: 768,
                world_y: 0,
                marks: Marks {
                    size: <UVec2 as VectorImpl>::new(31 as _, 19 as _),
                    entities: vec! {
                        EntityObject::new(Entity::PlayerStartPosition(PlayerStartPosition {
                        }), <FVec2 as VectorImpl>::new(16 as _, 224 as _), <UVec2 as VectorImpl>::new(16 as _, 16 as _)),
                    }
